...
const Footer = () => {
  return (
    <footer className="border-t py-12 text-center md:text-left px-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-4 lg:px-0">
        <div className="">
          <h3 className="text-lg text-gray-800 mb-4">Newsletter</h3>
          <p className="text-gray-500 mb-4">
            Be the first to hear about new products, exclusive envent, and
            online offers.
          </p>
          ...
          <form action="" className="flex">
            ...
            focus:outline-none focus:ring-2 focus:ring-gray-500 trainsition-all"
              required
            />

            <button
              type="submit"
              className="bg-black text-white px-6 py-3 text-sm rounded-r-md hover:bg-gray-800 trainsition-all"
            >
              Subscribe
            </button>
          </form>
