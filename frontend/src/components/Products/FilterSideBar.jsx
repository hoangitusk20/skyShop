...
const FilterSideBar = () => {
  ...
  return (
    <div className="p-4">
      ...
      {/* Size Filter    */}
      <div className="mb-6">
        <label className="block text-gray-600 font-medium ">Sizes</label>
      ...
      {/* Material filter */}
      <div className="mb-6">
        <label className="block text-gray-600 font-medium ">Material</label>
        <div className="flex flex-col gap-2">
          {materials.map((material) => (
            <div className="flex items-center" key={material}>
              <input
                type="checkbox"
                value={material}
                onChange={handleFilterChange}
      ...
      <div className="mb-8">
        ...
        <div className="flex justify-between text-gray-600 mt-2">
          <span>$0</span>
          <span>${Array.isArray(priceRange) ? priceRange[1] : priceRange}</span>
        </div>
      </div>
    </div>
  );
